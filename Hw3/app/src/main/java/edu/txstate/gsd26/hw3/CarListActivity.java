...
public class CarListActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Car car1 = new Car(101, "Mazda", "6",40.00, "https://www.mazdausa.com/vehicles/mazda6");
        Car car2 = new Car(102, "Honda","Accord",35.00, "https://automobiles.honda.com/accord-sedan");
        Car car3 = new Car(103, "Toyota", "Camry",35.00, "https://www.toyota.com/camry/");
        Car car4 = new Car(104, "Ford", "Focus",40.00, "https://www.ford.com/cars/fusion/");
        Car car5 = new Car(105, "Audi", "A4",50.00,"https://www.audiusa.com/models/audi-a4");
        ...
        setListAdapter(new ArrayAdapter<Car>(CarListActivity.this, R.layout.activity_car_list, R.id.txtCars, carList));
    }
}